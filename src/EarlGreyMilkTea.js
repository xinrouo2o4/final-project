    ...
    <div>
      ...
      <Row justify="center">
        ...
        <Col span={12} style={{ marginTop: '60px' }}>
          <Title level={2} style={{ color: '#000000', paddingLeft: '50px' }}>伯爵紅茶拿鐵</Title>
          ...
          <Title level={2} style={{ color: '#000000', paddingLeft: '50px' }}></Title>
          <Title level={5} style={{ color: '#3C3C3C', paddingLeft: '50px', lineHeight: '2.0' }}>有著特殊佛手柑果香的伯爵紅茶搭配綠光鮮奶，茶香濃郁口感醇厚</Title>
...
export default EarlGreyMilkTea;