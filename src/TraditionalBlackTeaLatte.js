...
const TraditionalBlackTeaLatte = () => {
    ...
    <div>
      ...
      <Row justify="center">
        ...
        <Col span={12} style={{ marginTop: '60px' }}>
          <Title level={2} style={{ color: '#000000', paddingLeft: '50px' }}>大正紅茶拿鐵</Title>
          ...
          <Title level={2} style={{ color: '#000000', paddingLeft: '50px' }}></Title>
          <Title level={5} style={{ color: '#3C3C3C', paddingLeft: '50px', lineHeight: '2.0' }}>使用自家綠光牧場鮮奶搭配古早味大正紅茶，帶有香草香氣和濃醇奶香。</Title>
...
export default TraditionalBlackTeaLatte;